...
## Now · [state.md](state.md)
–

## Waiting for you: 0 · [waiting.md](waiting.md)
–

## Sectors
| sector | state | privacy | what is there | notes | updated |
|---|---|---|---|---|---|
| [Core](sectors/core/_core.md) · [overview](_ai/index-core.md) | on | github | Your profile, how to work with you, people, tools, memory. | 0 | – |
