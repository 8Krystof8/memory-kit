...
// English (Porter2) stemmer for memory-kit (system/lang/en/stemmer.mjs).
// Source commit 411550ddb8ea049bc3e8d39bf56454e8a9ef0be6.
// BSD 3-clause license: see ../LICENSE-snowball.txt. Local changes: the base class is
// imported from ../snowball-base.mjs, the class is named, and the `stem` export at the end
// was added. Regenerate instead of editing by hand (steps in ../LICENSE-snowball.txt).

import BaseStemmer from '../snowball-base.mjs';
...
const instance = new EnglishStemmer();

/**
 * Stems one word. The input must be a lowercase, NFC-normalized token; the result keeps diacritics.
 * @param {string} word
 * @returns {string}
 */
export function stem(word) {
    return instance.stemWord(word);
}
